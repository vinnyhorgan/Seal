...
namespace Seal
{
    ...
    internal class ImguiController : IDisposable
    {
        ...
        void SetupInput()
        {
            ...
            io.KeyMap[(int)ImGuiKey.Tab] = (int)Raylib_cs.KeyboardKey.KEY_TAB;
            io.KeyMap[(int)ImGuiKey.LeftArrow] = (int)Raylib_cs.KeyboardKey.KEY_LEFT;
            io.KeyMap[(int)ImGuiKey.RightArrow] = (int)Raylib_cs.KeyboardKey.KEY_RIGHT;
            io.KeyMap[(int)ImGuiKey.UpArrow] = (int)Raylib_cs.KeyboardKey.KEY_UP;
            io.KeyMap[(int)ImGuiKey.DownArrow] = (int)Raylib_cs.KeyboardKey.KEY_DOWN;
            io.KeyMap[(int)ImGuiKey.PageUp] = (int)Raylib_cs.KeyboardKey.KEY_PAGE_UP;
            io.KeyMap[(int)ImGuiKey.PageDown] = (int)Raylib_cs.KeyboardKey.KEY_PAGE_DOWN;
            io.KeyMap[(int)ImGuiKey.Home] = (int)Raylib_cs.KeyboardKey.KEY_HOME;
            io.KeyMap[(int)ImGuiKey.End] = (int)Raylib_cs.KeyboardKey.KEY_END;
            io.KeyMap[(int)ImGuiKey.Insert] = (int)Raylib_cs.KeyboardKey.KEY_INSERT;
            io.KeyMap[(int)ImGuiKey.Delete] = (int)Raylib_cs.KeyboardKey.KEY_DELETE;
            io.KeyMap[(int)ImGuiKey.Backspace] = (int)Raylib_cs.KeyboardKey.KEY_BACKSPACE;
            io.KeyMap[(int)ImGuiKey.Space] = (int)Raylib_cs.KeyboardKey.KEY_SPACE;
            io.KeyMap[(int)ImGuiKey.Enter] = (int)Raylib_cs.KeyboardKey.KEY_ENTER;
            io.KeyMap[(int)ImGuiKey.Escape] = (int)Raylib_cs.KeyboardKey.KEY_ESCAPE;
            io.KeyMap[(int)ImGuiKey.A] = (int)Raylib_cs.KeyboardKey.KEY_A;
            io.KeyMap[(int)ImGuiKey.C] = (int)Raylib_cs.KeyboardKey.KEY_C;
            io.KeyMap[(int)ImGuiKey.V] = (int)Raylib_cs.KeyboardKey.KEY_V;
            io.KeyMap[(int)ImGuiKey.X] = (int)Raylib_cs.KeyboardKey.KEY_X;
            io.KeyMap[(int)ImGuiKey.Y] = (int)Raylib_cs.KeyboardKey.KEY_Y;
            io.KeyMap[(int)ImGuiKey.Z] = (int)Raylib_cs.KeyboardKey.KEY_Z;
        }
        ...
        void UpdateKeyboard()
        {
            ...
            io.KeyCtrl = io.KeysDown[(int)Raylib_cs.KeyboardKey.KEY_LEFT_CONTROL] || io.KeysDown[(int)Raylib_cs.KeyboardKey.KEY_RIGHT_CONTROL];
            io.KeyShift = io.KeysDown[(int)Raylib_cs.KeyboardKey.KEY_LEFT_SHIFT] || io.KeysDown[(int)Raylib_cs.KeyboardKey.KEY_RIGHT_SHIFT];
            io.KeyAlt = io.KeysDown[(int)Raylib_cs.KeyboardKey.KEY_LEFT_ALT] || io.KeysDown[(int)Raylib_cs.KeyboardKey.KEY_RIGHT_ALT];
            io.KeySuper = io.KeysDown[(int)Raylib_cs.KeyboardKey.KEY_LEFT_SUPER] || io.KeysDown[(int)Raylib_cs.KeyboardKey.KEY_RIGHT_SUPER];

            // Key states
            for (int i = (int)Raylib_cs.KeyboardKey.KEY_SPACE; i < (int)Raylib_cs.KeyboardKey.KEY_KB_MENU + 1; i++)
            {
                io.KeysDown[i] = Raylib.IsKeyDown((Raylib_cs.KeyboardKey)i);
            }
